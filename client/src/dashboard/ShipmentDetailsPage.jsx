...
const ShipmentDetailsPage = () => {
    return(
        ...
        <p class="shipment-title">Shipment Details</p>
            <div class="card-header text-white" style={{backgroundColor: '#01AA5A'}}>
            ...
            <div class="shipment-card-body">
                ...
                <div class="tracking-item row mb-4">
                    ...
                    <div class="col">
                        <div class="tracking-status  ">Your order is being processed at Jakarta, MP - Warehouse</div>
                    </div>
                </div>
                <div class="tracking-item row mb-4">
                    <div class="col-auto text-center">
                ...
                <div class="tracking-item row mb-4">
                    ...
                    <div class="col">
                        <div class="tracking-status  ">Your order arrived at Semarang & scheduled delivery is 14 November</div>
                    </div>
                </div>
                <div class="tracking-item row mb-4">
                    <div class="col-auto text-center">
                    ...
                    <div class="col">
                        <div class="tracking-status">Your order is out for delivery</div>
                    </div>
                </div>
