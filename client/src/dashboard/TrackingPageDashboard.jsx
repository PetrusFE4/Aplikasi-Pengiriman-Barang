              ...
              <tbody>
                <tr>
                  ...
                  <td className="align-middle">
                    <span className="badge rounded-pill status-delivered">Delivered</span>
                  </td>
                </tr>
                <tr>
                  ...
                  <td className="align-middle">
                    <span className="badge rounded-pill status-pending">Pending</span>
                  </td>
                </tr>
                <tr>
                  ...
                  <td className="align-middle">
                    <span className="badge rounded-pill status-shipping">Shipping</span>
                  </td>
                </tr>
              </tbody>
            </table>
